...
export const Contact = ({contact, closeContact}) => {
   return (
    ...
    >  
      ...
      <form className="form" action="https://formspree.io/rehm21@web.de"
          method="POST">
        ...
        <div className="label-email">
          ...
          <input placeholder="Email"type="email" name="_replyto" required></input>
        </div>
        <div className="label-message">
          
          <textarea placeholder="Write a message..."name="message" id="" ></textarea>
        </div>
  ...
  //  className="contact-right-wrapper"
   className={contact?"contact-right-wrapper is-open-right":"contact-right-wrapper"}
   >
    <div 
    // className="contact-right"
    className={contact ? "contact-right is-open-right" : "contact-right"}
    >
